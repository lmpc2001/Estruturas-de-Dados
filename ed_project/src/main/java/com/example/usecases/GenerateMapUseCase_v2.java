...
//  */
// public class GenerateMapUseCase_v2 {
// 	private Game game;
...
// 	 */
// 	public GenerateMapUseCase_v2(Game game) {
// 		this.game = game;
// 	}
...
//             Pair<Integer> coordinates = generateUniqueCoordinates(map);
//             map.addVertex(coordinates);
//         }
...
// 	private static Pair<Integer> generateUniqueCoordinates(GameMap map) {
//         Random random = new Random();
//         int x, y;
//         do {
//             x = random.nextInt(100); // Valor arbitrário, ajuste conforme necessário
//             y = random.nextInt(100);
//         } while (map.containsVertex(new Pair<>(x, y)));

//         return new Pair<>(x, y);
//     }

// 	private static void generateEdges(GameMap map, boolean bidirectional) {
//         Random random = new Random();
//         int numLocations = map.getNumberOfLocations();

//         for (int i = 0; i < numLocations; i++) {
//             for (int j = i + 1; j < numLocations; j++) {
//                 if (random.nextDouble() <= map.getEdgeDensity()) {
//                     map.addEdge(map.getVertex(i), map.getVertex(j));

//                     if (bidirectional) {
//                         map.addEdge(map.getVertex(j), map.getVertex(i));
//                     }
//                 }
//             }
//         }
